	...
	<xsl:template match="/">
		<html xmlns="http://www.w3.org/1999/xhtml">
			...
			<body>
				...
				<div id="footer">
					Generated with <a href="http://www.bin-co.com/php/programs/tools/sitemap_generator/" title="Google Sitemap Generator">Google Sitemap Generator</a>. This XSLT template is released under GPL(taken from Google Sitemap Generator WordPress Plugin).
				</div>
			</body>
		</html>
	</xsl:template>
